...
### 最近更新（v3.6）
- ✅ 管理员文章删除功能（登录后可在前端页面删除文章，支持从所有数据源删除）
- ✅ 全面优化移动端浏览器体验（侧边栏抽屉菜单、顶部导航下拉菜单、响应式布局）
- ✅ 添加每周资讯推荐功能（自动整理本周新增资讯为Markdown格式）
- ✅ 添加数据自动备份功能（每天23:00自动提交到GitHub）
- ✅ 添加日志存档功能（定时任务关键日志单独存档，保留90天）
