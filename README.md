...
| 特性 | 描述 |
| --- | --- |
| **资讯浏览** | 最新资讯（包含编程资讯、AI资讯）、每周资讯，支持搜索和分页 |
| **提示词** | 精选AI编程提示词，支持分类浏览、搜索和查看详情 |
| **规则** | Cursor Rules和其他AI编程规则，支持分类浏览和搜索 |
| **社区资源** | AI编程教程、文章和社区资源，按分类模块化显示 |
...
1. **浏览资讯**：
   - 点击"最新资讯"下拉菜单查看编程资讯或AI资讯
   - 点击"每周资讯"下拉菜单查看历史周报

2. **查看提示词**：
   - 访问 `/prompts` 查看精选AI编程提示词
   - 支持分类浏览、搜索和查看详情

3. **查看规则**：
   - 访问 `/rules` 查看Cursor Rules和其他AI编程规则
   - 支持分类浏览、搜索和完整内容展示

4. **浏览社区资源**：
   - 访问 `/resources` 查看AI编程教程、文章和社区资源
   - 按分类模块化显示，支持筛选
